...
class AuthManager {
    ...
    showCustomize() {
        ...
        // Cosmetics are temporarily parked behind a coming-soon state.
        ...
        if (grid) {
            grid.innerHTML = `
                <div style="
                    ...
                    text-align:center;
                ">
                    <div style="font-size:2.4rem;">COMING SOON</div>
                    <div style="color:#fff;font-weight:800;letter-spacing:0.08em;">Customization is being rebuilt</div>
                    <div style="color:#9ca3af;font-size:0.9rem;max-width:360px;line-height:1.45;">Skins and effects are temporarily unavailable while the system is redesigned.</div>
                </div>
            `;
        }
    ...
    updateCurrentlyEquipped() {
        ...
        if (container) {
            container.innerHTML = '<span style="color:#9ca3af;">Coming soon</span>';
        }
    }
    // ============================================
